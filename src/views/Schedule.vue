<template>
    <div class="schedule">
        <div class="calendar__wrapper">
            <div class="calendar">
                <div class="calendar__front" :class="{'show-details': flipped}">
                    ...
                    <div class="calendar__days">
                        ...
                        <div class="calendar__days__item calendar__days__item--today" @click="flipped = !flipped">15</div>
                ...
                <div class="calendar__back" :class="{ 'show-details': flipped }">
                    <p @click="flipped = !flipped">Voltar</p>
                </div>
            </div>
        </div>
